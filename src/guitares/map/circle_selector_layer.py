...
class CircleSelectorLayer(Layer):
    ...
    def set_data(self,
        ...
        # Add new layer
        self.map.runjs("/js/circle_selector_layer.js", "addLayer", arglist=[self.map_id,
                                                                                data.to_crs(4326),
                                                                                index,
                                                                                self.hover_property,
                                                                                self.line_color,
    ...
    def select_by_index(self, index):
        self.map.runjs("/js/circle_selector_layer.js", "selectByIndex", arglist=[self.map_id, index])

    def select_by_id(self, id):
        self.map.runjs("/js/circle_selector_layer.js", "selectById", arglist=[self.map_id, id])
    ...
    def deactivate(self):
        if self.data is None:
            ...
            return
        self.map.runjs("/js/circle_selector_layer.js", "deactivate", arglist=[self.map_id,
