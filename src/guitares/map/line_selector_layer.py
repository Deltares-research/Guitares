...
class LineSelectorLayer(Layer):
    ...
    def set_selected_index(self, index):
        self.map.runjs("/js/line_selector_layer.js", "setSelectedIndex", arglist=[self.map_id, index])


    def activate(self):
        # The line_selector_layer has no setPaintProperties yet.
        return
        self.map.runjs("/js/line_selector_layer.js", "setPaintProperties", arglist=[self.map_id,
                                                                               self.line_color,
                                                                               self.line_width,
                                                                               self.line_style,
                                                                               self.line_opacity,
