    ...
    def set_data(self,
        ...
        if image_file:
            ...
            with mem_file2.open(**kwargs) as dst:
                ...
                overlay_file = "./overlays/" + self.file_name
                im.save(os.path.join(self.map.server_path, "overlays", self.file_name))
        ...
        if self.new:
            self.map.runjs("/js/image_layer.js", "addLayer", arglist=[overlay_file, self.map_id, bounds, clrmap_string])
        else:
            self.map.runjs("/js/image_layer.js", "updateLayer", arglist=[overlay_file, self.map_id, bounds, clrmap_string])
