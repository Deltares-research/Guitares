"""PyQt5 push button that opens a file-save dialog."""
...
class PushSaveFile(QPushButton):
    """Button that opens a save-file dialog and stores the chosen path.
    ...
    def callback(self) -> None:
        """Open a save-file dialog and invoke the element callback with the selected path."""
        self.okay = True
