...
class ImageLayer(Layer):
    ...
    def make_overlay(self):    
        fname = os.path.join(self.maplibre.server_path, "overlays", self.file_name)
        coords = self.maplibre.map_extent
        xlim = [coords[0][0], coords[1][0]]
        ylim = [coords[0][1], coords[1][1]]
        width = self.maplibre.view.geometry().width()
    ...
    #     self.data = data
        ...
        # shutil.copy(image_file, os.path.join(self.maplibre.server_path, "overlays", self.file_name))
