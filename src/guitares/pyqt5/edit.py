"""PyQt5 line-edit widget with type validation and variable binding."""
...
class Edit(QLineEdit):
    """Single-line text editor bound to a GUI variable with type validation.

    Parameters
    ----------
    element : Any
        The GUI element descriptor with variable binding, type, text label, and callback.
    """
    ...
    def set(self) -> None:
        """Update the displayed text from the bound variable."""
    ...
    def callback(self) -> None:
        """Handle editing-finished events with type validation."""
        self.okay = True
        newtext = self.text()
