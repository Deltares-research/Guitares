...
class ListBox(QListWidget):
    """List box that syncs selected item(s) with a Guitares variable.

    Supports both single and multi-selection modes, and selection by
    item value or by index.

    Parameters
    ----------
    element : Any
        The Guitares element descriptor for this list box.
    """
    ...
    def set(self) -> None:
        """Update the list items and selection from the linked variables."""
    ...
    def add_items(self) -> None:
        """Populate the list box from the element's option strings."""
    ...
    def set_geometry(self) -> None:
        """Position and size the list box and its label."""
