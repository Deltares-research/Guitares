"""PySide6 push button that opens a file chooser dialog."""
...
class PushOpenFile(QPushButton):
    """Button that opens a file-open dialog and stores the selected path.
    ...
    def callback(self) -> None:
        """Open the file chooser and fire the element callback."""
        self.okay = True
