...
class RasterLayer(Layer):
    def __init__(self, maplibre, id, map_id):
    ...
    def clear(self):
        ...
        self.maplibre.view.page().runJavaScript(js_string)
    ...
    def set_data(self,
        ...
        if image_file:
            ...
            im.save(os.path.join(self.maplibre.server_path, overlay_file))
            ...
            with mem_file2.open(**kwargs) as dst:
                ...
                overlay_file = "./overlays/" + self.file_name
                im.save(os.path.join(self.maplibre.server_path, "overlays", self.file_name))
