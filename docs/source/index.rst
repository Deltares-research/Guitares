...
A Guitares GUI consists of a main window (with optional drop-down menu) that contains one or more UI elements. Guitares currently support the following UI elements (widgets):
