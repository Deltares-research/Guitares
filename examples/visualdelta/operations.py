...
def calculate_slr():
    ...
    csv_file = os.path.join(
        visualdelta.main_path, "slr", "SLR_{}.csv".format(visualdelta.ssp)
    )
...
def draw_polygon():
    visualdelta.gui.map_widget["main_map"].draw_polygon(
        "layer1", create=add_polygon, modify=modify_polygon
    )
...
def draw_polyline():
    visualdelta.gui.map_widget["main_map"].draw_polyline(
        "layer1", create=add_polyline, modify=modify_polyline
    )
...
def draw_rectangle():
    visualdelta.gui.map_widget["main_map"].draw_rectangle(
        "layer1", create=add_rectangle, modify=modify_rectangle
    )
